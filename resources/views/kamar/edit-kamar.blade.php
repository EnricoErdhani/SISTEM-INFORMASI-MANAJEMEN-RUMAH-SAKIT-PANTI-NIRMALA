                            ...
                            <form action="{{ route('kamar.update', $kamar->ID_KAMAR) }}" method="post">
                                ...
                                @method('PUT')
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama Jenis Kamar</label>
                                        <select class="form-control" name="id_jkamar" id="id_jkamar" required>
                                            @foreach ($jenis as $k)
                                                <option value="{{ $k->ID_JKAMAR }}">
                                                    {{ $k->NAMA_KAMAR }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_kamar" class="form-control"
                                            id="exampleInputPassword1" value="{{ $kamar->NAMA_KAMAR }}"
