                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bentuk_obat" class="form-control"
                                            id="exampleInputEmail1" value="{{ $obat->BENTUK_OBAT }}"
                                             placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Dosis</label>
                                        <input type="text" name="dosis" class="form-control"
                                            id="exampleInputEmail1" value="{{ $obat->DOSIS }}"
                                             placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Cara Pemakaian</label>
                                        <textarea name="cara_pemakaian" id="cara_pemakaian" class="form-control">{{ $obat->CARA_PEMAKAIAN }}"</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Komposisi</label>
                                        <textarea name="komposisi" id="komposisi" class="form-control">{{ $obat->KOMPOSISI }}"</textarea>
                                    </div>
                                    <div class="form-group">
