                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor_izin_praktik" class="form-control"
                                            id="exampleInputPassword1" value="{{ $dokter->NOMOR_IZIN_PRAKTIK }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_kadaluarsa_izin_praktik" class="form-control"
                                            id="exampleInputEmail1" value="{{ $dokter->TANGGAL_KADALUARSA_IZIN_PRAKTIK }}"
                                            placeholder="Enter Tanggal">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama</label>
                                        <input type="text" name="nama" value="{{ $dokter->NAMA }}"
                                            class="form-control" id="exampleInputEmail1" placeholder="Enter nama">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Jenis Kelamin</label>
                                        <input type="text" name="jenis_kelamin" class="form-control"
                                            id="exampleInputEmail1" value="{{ $dokter->JENIS_KELAMIN }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="spesialisasi" class="form-control"
                                            id="exampleInputEmail1" value="{{ $dokter->SPESIALISASI }}" placeholder="Enter spesialisasi">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Gaji</label>
                                        <input type="text" name="gaji" value="{{ $dokter->GAJI }}" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter gaji">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Status</label>
                                        <input type="text" name="status" value="{{ $dokter->STATUS }}" class="form-control" id="exampleInputEmail1"
