    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Jenis Kamar</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fasilitas" class="form-control"
                                            id="exampleInputPassword1" placeholder="Enter Fasilitas">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Harga</label>
                                        <input type="number" name="harga" class="form-control"
                                            id="exampleInputPassword1" placeholder="Enter Harga">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Ketersediaan</label>
                                        <input type="number" name="ketersediaan" class="form-control"
                                            id="exampleInputPassword1" placeholder="Enter Ketersediaan">
                                    </div>
                                </div>
                                <!-- /.card-body -->
